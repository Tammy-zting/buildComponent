import './index.less';
import { Button, Divider, Drawer, Icon, List, Select, Switch, Tooltip, message, } from 'antd';
...
const { Option } = Select;
const Body = ({ children, title }) =>  <div style={{ marginBottom: 24 }}>
...
class SettingDrawer extends Component {
    ...
    render() {
        ...
        const { navTheme = 'dark', primaryColor = '1890FF', layout = 'sidemenu', colorWeak, } = settings || defaultSettings;
        const { collapse } = this.state;
        const formatMessage = this.getFormatMessage();
        return (
            <Drawer
